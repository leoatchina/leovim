...
if InstalledFzf()
    function! s:load_json(dap, ...)
        ...
        if dap
            let json_file = fnamemodify(GetRootDir() . '/.vscode/launch.json', ':p')
...
if Installed('vimspector')
    ...
    if InstalledFzf()
        ...
        nnoremap <leader>rO :tabe ~/.leovim/vimspector/
    endif
    " core keymaps
    ...
    nnoremap <silent><M-F> :FocusCode<Cr>
...
elseif Installed('nvim-dap', 'nvim-dap-ui', 'nvim-nio', 'mason.nvim', 'mason-nvim-dap.nvim')
    ...
    if InstalledFzf()
        ...
        nnoremap <leader>rO :tabe ~/.leovim/nvim-dap/
    endif
    " core keymaps
    ...
    function! s:dap_or_floaterm(...)
        if s:dapui_exists()
            ...
            elseif a:1 == 'F'
                call GoToDAPWindows("DAP Console")
                wincmd k
            elseif a:1 == '-'
                call GoToDAPWindows("DAP Console")
            elseif a:1 == '_'
