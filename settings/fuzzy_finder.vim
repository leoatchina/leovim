...
if Installed('vim-quickui')
    ...
    nmap <silent><expr> <C-j> quickui#preview#visible() > 0 ? quickui#preview#scroll(3)  : "\<C-j>"
    nmap <silent><expr> <C-k> quickui#preview#visible() > 0 ? quickui#preview#scroll(-3) : "\<C-k>"
    " preview in popup
