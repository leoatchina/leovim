...
if has('clipboard')
    ...
    xnoremap <silent><M-v> "zgP
    nnoremap <silent><M-c> "zy
    xnoremap <silent><M-c> "zy
    nnoremap <silent><M-x> "zx
    xnoremap <silent><M-x> "zx
    nnoremap <silent><M-X> "zdd
...
au VimEnter,BufNewFile,BufRead *.lidr set filetype=lidris
au VimEnter,BufNewFile,BufRead *.lfe, set filetype=lfe
...
" zfvim
" --------------------------
if get(g:, 'input_method', '') == 'zfvim' && get(g:, 'complete_engine', '') != 'vim-lsp'
