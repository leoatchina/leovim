...
if has('nvim')
    autocmd FocusGained,TermLeave,TermClose * if mode() ==# 'n' && &bt !=# 'terminal' | silent! checktime | endif
elseif !utils#has_gui()
    autocmd FocusGained,WinEnter * if &bt !=# 'terminal' | silent! checktime | endif
endif
" -----------------------------------
" swap exists ignore
" -----------------------------------
