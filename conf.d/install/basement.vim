...
if has('nvim-0.10') && Planned('nvim-treesitter') && (Planned('copilot.lua') ||
            \ exists('$HYPERBOLIC_API_KEY') || exists('$OPENROUTER_API_KEY') || exists('$ANTHROPIC_API_KEY') || exists('$GEMINI_API_KEY') || exists('$OPENAI_API_KEY'))
