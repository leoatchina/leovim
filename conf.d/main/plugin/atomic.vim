...
if pack#installed('hop.nvim')
    ...
    if !pack#planned('flash.nvim')
        nmap sn <Plug>(easymotion-f2)
        xmap sn <Plug>(easymotion-f2)
        omap sn <Plug>(easymotion-f2)
        nmap sp <Plug>(easymotion-F2)
        xmap sp <Plug>(easymotion-F2)
        omap sp <Plug>(easymotion-F2)
